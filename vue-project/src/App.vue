...
<div v-if="info.checkLogin=='logout'" >
  <div class="flex justify-content-center align-items-center min-h-screen"  style="background-image: url('wallpaper.jpg'); background-size: cover;">
    <LoginComponent />
  </div>
</div>
...
<div v-else class="border-round-xl surface-border">
  ...
  <div>
    ...
    <!-- without sidebar 1 -->
    <div v-else-if="offSidebar1==true && offSidebar2==false" class="flex relative lg:static surface-ground" style="height:93vh">
